...
public class JsonTextComparatorTest {
	...
	public void testDiff() throws Exception {
		...
		assertEquals("/data/val:DIFF:J1[\"v1.1\"];J2[\"v2\"],/val:DIFF:J1[\"v1\"];J2[\"v2\"],/list:DIFF:J1[[1,2,3]];J2[[1,4,3]]", actual);
	}
	
	@Test
	public void testIgnore1() throws Exception {
		String actual = jtc.addKeyToIgnore("val").setJson(
			read(this.getClass().getResourceAsStream("obj1.json")),
			read(this.getClass().getResourceAsStream("obj2.json"))).compare();
	...
	public void testIgnore2() throws Exception {
		String actual = jtc.addPathToIgnore("/data/val").addKeyToIgnore("list").setJson(
			read(this.getClass().getResourceAsStream("obj1.json")),
			read(this.getClass().getResourceAsStream("obj2.json"))).compare();
	...
	public void testNullIsEmpty() throws Exception {
		String actual = jtc.enableNullIsUnavailable().setJson(
			read(this.getClass().getResourceAsStream("nullcheck1.json")),
			read(this.getClass().getResourceAsStream("nullcheck2.json"))).compare();
		assertNull(actual);
	}
}
